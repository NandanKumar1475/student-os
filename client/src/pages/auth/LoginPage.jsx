...
const LoginPage = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#07111f] text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(73,195,255,0.2),transparent_35%),radial-gradient(circle_at_80%_20%,rgba(255,170,92,0.16),transparent_22%),linear-gradient(135deg,#04111f_0%,#071b2d_45%,#02060d_100%)]" />
      <div className="absolute inset-0 opacity-50 bg-[linear-gradient(rgba(255,255,255,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.05)_1px,transparent_1px)] bg-size-[72px_72px] mask-[radial-gradient(circle_at_center,black,transparent_78%)]" />
      ...
      <div className="relative z-10 flex min-h-screen flex-col lg:flex-row">
        <div className="flex w-full items-center px-6 py-14 sm:px-10 lg:w-[58%] lg:px-14 xl:px-20">
          ...
          >
            <div className="inline-flex items-center gap-2 rounded-full border border-cyan-300/20 bg-white/8 px-4 py-2 text-sm text-cyan-100 backdrop-blur-md">
              ...
              Student OS turns study effort into visible progress.
            </div>
            ...
            <div className="mt-8 max-w-2xl">
              ...
              <p className="mt-6 max-w-xl text-base leading-7 text-slate-300 sm:text-lg">
                Bring assignments, DSA practice, notes, goals, and placement prep into one focused dashboard that rewards consistent action.
              </p>
            </div>
            ...
            <div className="mt-12 hidden lg:block">
              <div className="relative h-80 overflow-hidden rounded-4xl border border-white/10 bg-[linear-gradient(135deg,rgba(255,255,255,0.1),rgba(255,255,255,0.03))] p-6 backdrop-blur-2xl">
                ...
                <div className="relative flex h-full flex-col justify-between">
                  ...
                  <div className="grid grid-cols-[1.3fr_0.9fr] gap-4">
                    <div className="rounded-3xl border border-white/10 bg-slate-950/35 p-5">
                      ...
                      <p className="mt-1 text-xs text-slate-400">practice sets</p>
                        </div>
                        <div className="rounded-2xl bg-white/6 p-3">
                    ...
                    <div className="space-y-4">
                      <MotionDiv
                        ...
                        className="rounded-3xl border border-cyan-200/15 bg-cyan-300/10 p-4 text-cyan-50 backdrop-blur-md"
                      >
                      ...
                      <MotionDiv
                        ...
                        className="ml-8 rounded-3xl border border-orange-200/15 bg-orange-300/10 p-4 text-orange-50 backdrop-blur-md"
                      >
                        <div className="flex items-center gap-3">
                          <Sparkles size={18} />
        ...
        <div className="flex w-full items-center justify-center px-6 pb-14 sm:px-10 lg:w-[42%] lg:px-14 lg:pb-0">
          <MotionDiv
            ...
            className="relative w-full max-w-md overflow-hidden rounded-4xl border border-white/12 bg-[linear-gradient(180deg,rgba(8,20,34,0.88),rgba(8,18,31,0.68))] p-8 shadow-[0_30px_80px_rgba(0,0,0,0.45)] backdrop-blur-2xl"
          >
